...
def load_model(checkpoint_path, num_classes, device):
    ...
    model = PokemonClassifierEfficientNetB2_3reg(num_classes=num_classes)
...
def main():
    ...
    # Kanto
    test_images = [
        "test_images/images/000_bulbasaur.png",
        "test_images/images/005_charizard.png",
        "test_images/images/024_pikachu.png",
        "test_images/images/191_sunflora.png",
    ]
